...
import { LIBRARY_STAGES, LibraryStage, shortLessonFocus } from '@/src/lib/library-pathway';
...
const styles = StyleSheet.create({
  ...
  lessonRow: { minHeight: 39, borderBottomWidth: 1, borderBottomColor: '#E1E6EC', flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 6 },
  lessonNumber: { width: 40, fontSize: 12, fontWeight: '700' },
