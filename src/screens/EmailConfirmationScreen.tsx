    ...
    () =>
      uiLanguage === 'th'
        ? {
            ...
            instructions: 'กรุณาคลิกลิงก์ในอีเมลเพื่อดำเนินการต่อ หากมีบัญชีอยู่แล้ว เราจะพาคุณเข้าสู่ระบบโดยไม่สร้างบัญชีซ้ำ',
            ...
            sending: 'กำลังส่ง...',
            success: 'ส่งลิงก์แล้ว! กรุณาตรวจสอบกล่องจดหมายของคุณ',
        ...
        : {
            ...
            instructions: "Tap the link to continue. If this email already has an account, we'll sign you in instead of creating another one.",
            help: "If it doesn't arrive within a few minutes, check your spam or junk folder, or resend it below.",
            resend: 'Resend email',
            sending: 'Sending...',
            success: 'Sign-in link sent! Check your inbox.',
