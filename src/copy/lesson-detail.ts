...
export const getLessonDetailCopy = (language: UiLanguage) => {
  if (language === 'th') {
    return {
      ...
      greatJob: 'ทำได้ดีมาก! ลองอีกครั้งไหม?',
      ...
      translationComingSoonTitle: 'เร็วๆ นี้!',
      translationComingSoonBody: 'คำแปลภาษาไทยกำลังจะมาเร็วๆ นี้!',
      ...
      applyNextSectionHint: 'ลองทำดูก่อนและดูคำตอบตัวอย่างก่อนขยับไปส่วนถัดไป',
      ...
      practiceChecking: 'กำลังตรวจคำตอบ...',
      ...
      understandNextSectionHint: 'อ่านส่วนนี้ให้จบก่อนค่อยไปต่อ',
  ...
  return {
    ...
    translationComingSoonTitle: 'Coming soon!',
    translationComingSoonBody: 'Thai translations are coming soon!',
    ...
    applyNextSectionHint: 'Give it a try and check the example answer before moving to the next section.',
    ...
    understandNextSectionHint: 'Read through to the end of this section before moving on.',
